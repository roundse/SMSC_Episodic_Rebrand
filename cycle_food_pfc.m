function returnable = cycle_food_pfc(food_in, input_weights, input, value)
    ...
    if nargin < 3
        ...
        if input_weights
                [w_pfc_to_food w_food_to_pfc] = recurrent_oja(food_out, food_in, pfc_in, ...
                    w_pfc_to_food, w_food_to_pfc, VAL, 1);
